...
# Install restissimo for parallel downloads
sudo su vagrant <<'EOF'
...
apt-get install -y --allow-downgrades --allow-remove-essential --allow-change-held-packages \
nginx php7.1-fpm php7.3-fpm php7.2-fpm php7.0-fpm
